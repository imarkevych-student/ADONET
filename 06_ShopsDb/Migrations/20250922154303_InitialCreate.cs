    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "вул. Хрещатик 1", 1, "Магазин A", 50 },
                    { 2, "вул. Головна 12", 2, "Магазин B", 30 },
                    { 3, "вул. Центральна 5", 3, "Магазин C", 40 },
                    { 4, "вул. Шевченка 22", 4, "Магазин D", 60 },
                    { 5, "вул. Рішельєвська 8", 5, "Магазин E", 35 }
                });
